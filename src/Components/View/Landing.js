    ...
    <main className="landing_body">
      ...
      <article className="steps">
        <div className='demo_creds'>
          ...
          <p>Select: Yahoo</p>
          <p>Email: demo_jd7@yahoo.com</p>
          <p>Password: Password!17 </p>
        </div>
        ...
        <div className="create_deck_desc">
          ...
          <div>
            ...
            <p>
              Start by naming a new deck and giving it a category. You can add
              as many cards and sub-decks as you want!{" "}
            </p>
          </div>
        </div>
        <div className="create_card_desc">
          <div className="card_desc">
            ...
            <p>
              For every card, add a question on the front and the answer on the
              back.
            </p>
          </div>
          <div className="card_example">
            ...
            <img
              src="http://www.clker.com/cliparts/g/y/g/4/r/h/tan-index-card.svg"
              alt="card_image"
              className="img_card"
            />
            <p className="answer_desc">
              .reverse() is a prototype method that reverses the order of an
              array
            </p>
          </div>
        </div>
        <section className="study_desc">
          <div>
            ...
            <p>
              {" "}
              Once your deck is filled up with your custom-made cards, you can
              study them by viewing each card one at a time.
            </p>
          </div>
          <img
            src="https://www.simplebackpain.com/images/computeruser.jpg"
            alt="study_image"
            className="img_card"
          />
        </section>
